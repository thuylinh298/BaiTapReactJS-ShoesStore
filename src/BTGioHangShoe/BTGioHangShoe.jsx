...
export default class BTGioHangShoe extends Component {
    shoesList = [
        {
            "id": 1,
    ...
    render() {
        return (
            <div className="container">
                <h2 className="text-center py-3">Today's special</h2>
                <DanhSachSP getShoeDetail={this.getShoeDetail} shoesList={this.shoesList} />
